...
- **Critical Policies surfacing**: Add a "Critical Policies (Read First)" callout in `100_memory/100_cursor-memory-context.md` (Safety Ops, Exclusions, Validators/Tests, Post‑Change `python3 scripts/update_cursor_memory.py`). Cross‑link from `400_guides/400_system-overview.md` (Safety Ops anchor) and `400_guides/400_context-priority-guide.md` (mini‑index).
...
Quick links: `100_memory/100_cursor-memory-context.md`, `400_guides/400_system-overview.md`, `400_guides/400_context-priority-guide.md`
...
- *🤖 Execution Guide**: Items can be executed directly by AI using `000_core/003_process-task-list.md` as the execution engine.
...
<!--score_total: 3.8-->
<!-- default_executor: 000_core/003_process-task-list.md -->
...
000_core/003_process-task-list.md. Constitution provides persistent rules to prevent context loss and ensure safety across all AI
operations.-->
...
comprehensive testing, and 400_guides/400_documentation-retrieval-guide.md for complete usage guide. System provides relevant
...
migration summary. Consolidated 400_guides/400_contributing-guidelines.md into single file for solo developer workflow. Excluded
...
| C‑052 | Giant Guide File Splitting | 📈  | 8        | ✅ done | 2024-08-07 | Complete implementation with giant guide splitter, migration script, cross-reference updates, and comprehensive documentation. Consolidated 400_guides/400_contributing-guidelines.md into single file for solo developer workflow. Excluded project-specific deliverables (B-011, B-049, B-072 files) as they should remain intact. |
...
| S‑004 | Cursor Native AI Setup               | 🔥  | 1        | setup-required | Cursor IDE configuration | See `200_setup/202_setup-requirements.md` |
...
execution_responsibility: |
  Check <!-- default_executor: 000_core/003_process-task-list.md --> for AI-executable items
