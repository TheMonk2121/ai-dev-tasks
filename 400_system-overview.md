...
## 🎯 **Current Status**-**Status**: ✅ **ACTIVE**- System overview maintained
...
- **do next**: Jump to `#architecture` and `#core-components`; then review `400_testing-strategy-guide.md` and `400_deployment-environment-guide.md`.

- **anchors**: `architecture`, `context-management`, `core-components`, `workflow`, `security`, `performance`, `integration`, `deployment`, `testing`

## 🧭 Critical Path

1) `100_cursor-memory-context.md` → 2) `000_backlog.md` → 3) `400_system-overview.md` → 4) topic guide
...
### **Backlog scoring & automation**- Canonical scoring details (formula, ranges, metadata, AI usage) live in `100_backlog-guide.md` → see “AI Scoring System” and “n8n Backlog Scrubber”.
...
### **Implementation Guides**-**`400_file-analysis-guide.md`**: Systematic file analysis methodology
