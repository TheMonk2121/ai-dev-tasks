...
class IntentRouter:
    ...
    def classify_intent(self, query: str, request_id: str | None = None) -> IntentClassification:
        """
...
def create_intent_router(config: IntentRouterConfig | None = None) -> IntentRouter:
