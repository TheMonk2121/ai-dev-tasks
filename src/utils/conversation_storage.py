        ...
        try:
            ...
            if "effectiveness" in analytics and "relevance_effectiveness" in analytics["effectiveness"]:
                ...
                if avg_relevance < 0.6:
                    recommendations["decision_quality"]["relevance_issue"] = (
                ...
                if low_relevance_count > 0:
                    recommendations["decision_quality"]["low_relevance_decisions"] = (
            ...
            if "entity_analysis" in analytics and "entity_relevance_correlation" in analytics["entity_analysis"]:
                ...
                if low_relevance_entities:
                    recommendations["entity_optimization"]["low_relevance_entities"] = (
            ...
            if "analytics" in analytics and "supersedence_patterns" in analytics["analytics"]:
                ...
                if supersedence_rate > 0.3:
                    recommendations["supersedence_insights"]["high_supersedence"] = (
                    ...
                    recommendations["supersedence_insights"]["low_supersedence"] = (
                        f"Low supersedence rate ({supersedence_rate:.1%}). Decisions appear stable."
                    )
                else:
                    recommendations["supersedence_insights"]["balanced_supersedence"] = (
            ...
            if "trends" in analytics and "daily_decision_count" in analytics["trends"]:
                ...
                if daily_counts:
                    ...
                    if recent_avg > 5:
                        recommendations["trend_recommendations"]["high_decision_volume"] = (
                        ...
                        recommendations["trend_recommendations"]["low_decision_volume"] = (
