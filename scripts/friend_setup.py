...
class FriendSetup:
    ...
    def install_default_model(self):
        ...
        print("📥 Installing default AI model...")
        
        try:
            subprocess.run(["ollama", "pull", self.config["model"]], 
                         check=True)
            print(f"✅ Model {self.config['model']} installed successfully.")
            return True
        except subprocess.CalledProcessError as e:
...
"""
    ...
    def run_setup(self):
        ...
        steps = [
            ...
            ("Install default model", self.install_default_model),
