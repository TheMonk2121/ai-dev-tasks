...
#!/usr/bin/env python3
"""
DEPRECATED: legacy two-agent chat bridge.

This bridge has been superseded by scripts/multi_agent_chat.py. This file remains
as a thin wrapper to preserve paths referenced in documentation.
"""

print("[DEPRECATED] Use scripts/multi_agent_chat.py instead of scripts/chat_bridge.py", file=sys.stderr)
