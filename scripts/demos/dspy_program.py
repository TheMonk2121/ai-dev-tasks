...
# sys.path.insert(0, "src")  # REMOVED: DSPy venv consolidated into main project
import dspy
...
def compile_rag(
    ...
    teleprompter = dspy.teleprompt.BootstrapFewShot(metric=metric, max_bootstrapped_demos=6, max_labeled_demos=4)
...
with open(args.trainset) as f:
        ...
        print("✅ DSPy RAG program compiled successfully")
