#!/usr/bin/env python3
"""
Historical Evaluation Data Migration Script
...
class HistoricalEvalMigrator:
    ...
    def migrate_all_evaluations(self, base_dir: str = "300_evals/metrics") -> dict[str, Any]:
...
def main():
    ...
    parser.add_argument("--base-dir", default="300_evals/metrics", help="Base directory to search for evaluation files")
    ...
    try:
        with HistoricalEvalMigrator(dsn=args.dsn, dry_run=args.dry_run) as migrator:
            ...
            if not args.dry_run:
                ...
                print(f"📈 Total data points: {stats['events_created'] + stats['case_results_created']}")
            else:
