...
# Precision Optimization - Full Evaluation (15 Cases)
# Uses the working direct environment variable approach

set -e

echo "🎯 Precision Optimization - Full Evaluation (15 Cases)"
echo "======================================================"
echo "Using direct environment variables (bypassing shell overrides)"
echo ""
...
# Disable fast mode for full evaluation
...
echo "   RAGCHECKER_FAST_MODE=0 (full evaluation)"
