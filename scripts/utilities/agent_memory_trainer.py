        ...
        workflows["ragchecker_evaluation"] = EvaluationWorkflow(
            ...
            steps=[
                ...
                },
                {
                    ...
                    "command": "uv run python scripts/evaluation/ragchecker_official_evaluation.py --use-bedrock --bypass-cli --stable",
...
3. Run evaluation (uv run python scripts/evaluation/ragchecker_official_evaluation.py)
