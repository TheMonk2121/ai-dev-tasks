...
def validate_gold_dataset() -> list[str]:
    ...
    gold_file = Path("300_evals/data/gold/v1/gold_cases.jsonl")
    manifest_file = Path("300_evals/data/gold/v1/manifest.json")

    # Check files exist
    if not gold_file.exists():
        issues.append("Gold dataset file missing: 300_evals/data/gold/v1/gold_cases.jsonl")
        return issues

    if not manifest_file.exists():
        issues.append("Manifest file missing: 300_evals/data/gold/v1/manifest.json")
        return issues
