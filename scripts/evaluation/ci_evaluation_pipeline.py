#!/usr/bin/env python3
"""
DEPRECATED: CI Evaluation Pipeline (legacy repo-gold orchestration).

Use GitHub Actions workflows with scripts/smoke_eval_gate.py and v1 gold instead.
This remains for archival reference only.
"""
