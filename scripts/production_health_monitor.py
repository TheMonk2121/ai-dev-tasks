...
def generate_health_report(
    ...
    overall_healthy = (
        config_health.get("validation", {}).get("valid", False) and
        retrieval_health.get("healthy", False) and
        not config_health.get("error") and
        not retrieval_health.get("error")
    )
...
def main():
    ...
    parser.add_argument("--eval-results-dir", default="metrics/baseline_evaluations", 
