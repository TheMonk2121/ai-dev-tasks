...
'''
    ...
    for i, chunk in enumerate(smart_chunks):
        ...
        print(f"    Stitching key: {chunk.stitching_key}")
    ...
    for chunk in stitched_chunks:
        if hasattr(chunk, "is_stitched") and chunk.is_stitched:
            print(f"  ✅ Stitched: {chunk.function_name}")
            print(f"     Original chunks: {chunk.original_count}")
