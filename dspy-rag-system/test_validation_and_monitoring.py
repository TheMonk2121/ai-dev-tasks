...
def test_validation_system():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "routing_result": {
                "status": "success",
                "selected_model": CursorModel.MISTRAL_7B_INSTRUCT.value,
                "confidence": 0.6,
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        validation_result = validator.validate_routing_decision(
            test_case['routing_result'], 
            test_case['query']
        )
...
def test_monitoring_system():
    ...
    for i, scenario in enumerate(test_scenarios, 1):
        ...
        monitor.log_routing_attempt(
            scenario['query'],
            scenario['routing_result'],
            scenario['latency_ms']
        )
...
def test_hallucination_detection():
    ...
    hallucination_tests = [
        ...
        },
        {
            ...
            "routing_result": {
                "status": "success",
                "selected_model": CursorModel.MISTRAL_7B_INSTRUCT.value,  # Wrong for complex reasoning
                "confidence": 0.8,
