...
def test_gate_security():
    ...
    normal_result = cursor_orchestrate_task(
    ...
    suspicious_result = cursor_orchestrate_task(
    ...
    print("\n🎯 Test 3: Another suspicious request")
    suspicious_result2 = cursor_orchestrate_task(
    ...
    print("\n🎯 Test 4: Invalid role")
    invalid_role_result = cursor_orchestrate_task(
        "Test task", 
        "analysis", 
        "hacker"
    )
