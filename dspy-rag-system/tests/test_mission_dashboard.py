...
try:
    from mission_dashboard.mission_tracker import (
        MissionTracker, Mission, MissionStatus, MissionPriority, MissionMetrics
    )
...
class TestMissionTracker(unittest.TestCase):
    ...
    def test_start_mission(self):
        ...
        success = self.tracker.start_mission(
    ...
    def test_update_mission_progress(self):
        ...
        success = self.tracker.update_mission_progress(
            mission_id=mission_id,
            progress=50.0,
            result={"step": "halfway"}
        )
    ...
    def test_fail_mission(self):
        ...
        success = self.tracker.fail_mission(
            mission_id=mission_id,
...
class TestMissionDashboardAPI(unittest.TestCase):
    ...
    def test_create_mission_api(self):
        ...
        response = self.app.post('/api/missions', 
                               json={
                                   'title': 'New Mission',
    ...
    def test_start_mission_api(self):
        ...
        response = self.app.post('/api/missions/test-id/start',
                               json={'agent_type': 'TestAgent', 'model_used': 'test-model'})
    ...
    def test_update_mission_progress_api(self):
        ...
        response = self.app.post('/api/missions/test-id/progress',
                               json={'progress': 50.0, 'result': {'step': 'halfway'}})
    ...
    def test_complete_mission_api(self):
        ...
        response = self.app.post('/api/missions/test-id/complete',
                               json={
                                   'result': {'status': 'completed'},
                                   'tokens_used': 1000,
                                   'cost_estimate': 0.1
    ...
    def test_fail_mission_api(self):
        ...
        response = self.app.post('/api/missions/test-id/fail',
...
class TestMissionDashboardIntegration(unittest.TestCase):
    ...
    def test_full_mission_lifecycle(self):
        ...
        # Start mission
        response = self.app.post(f'/api/missions/{mission_id}/start', json={
        ...
        # Update progress
        response = self.app.post(f'/api/missions/{mission_id}/progress', json={
            'progress': 50.0,
            'result': {'step': 'halfway'}
        })
        self.assertEqual(response.status_code, 200)
        ...
        # Complete mission
        response = self.app.post(f'/api/missions/{mission_id}/complete', json={
            'result': {'status': 'completed'},
            'tokens_used': 2000,
            'cost_estimate': 0.2
        })
