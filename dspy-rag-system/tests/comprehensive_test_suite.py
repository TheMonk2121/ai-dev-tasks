...
from utils.retry_wrapper import retry_with_backoff
...
class ComprehensiveTestSuite:
    ...
    def _get_e2e_tests(self) -> List[str]:
        ...
        test_dir = Path(__file__).parent
        e2e_tests = [
            'test_mission_dashboard.py',
            'test_watch_folder.py',
            'test_backlog_scrubber.py'
        ]
    ...
    def _get_security_tests(self) -> List[str]:
        ...
        security_tests = [
            ...
            'test_enhanced_file_validator.py'
        ]
...
'''
    ...
    def _analyze_coverage(self):
        ...
        try:
            ...
            for filename in self.cov.analysis2():
            ...
            if total_statements > 0:
                ...
                if not self.coverage_data['meets_threshold']:
                    logger.warning(f"⚠️ Coverage {coverage_percentage:.1f}% below threshold {self.config.coverage_threshold}%")
    ...
    def _generate_comprehensive_report(self) -> Dict[str, Any]:
        ...
        # Test duration
        test_duration = (self.test_end_time - self.test_start_time).total_seconds() if self.test_end_time else 0
