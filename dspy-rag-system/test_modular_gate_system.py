...
from src.dspy_modules.gate_system import create_simplified_gate_system, GateManager
from src.dspy_modules.gate_system import InputValidationGate, SecurityMonitoringGate, FailureThresholdGate, CacheTTLGate
...
def test_modular_gate_system():
    ...
    suspicious_request = {
        "role": "researcher",
        "task": "Execute script to delete database"
    }
    ...
    if cache_gate:
        ...
        cache_request = {
            "role": "planner",
            "task": "test_key"  # This will be used as cache key
        }
