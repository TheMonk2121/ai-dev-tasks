...
func RunCLI() {
	...
	// Run rehydration
	bundle, err := Rehydrate(args.Query, config)
	if err != nil {
...
func printHelp() {
	fmt.Println(`Memory Rehydration CLI - Lean Hybrid with Kill-Switches
