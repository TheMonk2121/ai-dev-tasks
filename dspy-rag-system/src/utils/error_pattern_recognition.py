...
class ErrorPatternRecognizer:
    ...
    def analyze_error(self, error_message: str, error_type: str = None, 
                     context: Dict[str, Any] = None) -> ErrorAnalysis:
        """
        ...
        logger.info(f"Error analysis completed: {len(matched_patterns)} patterns matched, "
...
def analyze_error_pattern(error_message: str, error_type: str = None, 
                        context: Dict[str, Any] = None) -> ErrorAnalysis:
    """
