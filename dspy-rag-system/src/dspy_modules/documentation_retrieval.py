...
class DocumentationQueryProcessor(Module):
    ...
    def __init__(self):
        super().__init__()
        self.query_processor = dspy.ChainOfThought("user_query, context_type, query_type -> processed_query, search_categories, expected_context")
...
class DocumentationRetriever(Module):
    ...
    def __init__(self, vector_store: HybridVectorStore):
        ...
        self.retrieval_processor = dspy.ChainOfThought("processed_query, search_categories, retrieved_chunks -> relevant_context, context_summary, confidence_score, context_metadata")
    ...
    def forward(self, processed_query: str, search_categories: List[str], limit: int = 5) -> Dict[str, Any]:
        ...
        search_results = self.vector_store.forward(
            operation="search",
...
class ContextSynthesizer(Module):
    ...
    def __init__(self):
        super().__init__()
        self.synthesis_processor = dspy.ChainOfThought("user_query, retrieved_contexts -> context_synthesis, context_priority, context_coverage")
    ...
    def forward(self, user_query: str, retrieved_contexts: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        result = self.synthesis_processor(
            user_query=user_query,
            retrieved_contexts=json.dumps(retrieved_contexts)
        )
...
class DocumentationRetrievalService(Module):
    ...
    def __init__(self, db_connection_string: str):
        ...
        self.rag_system = EnhancedRAGSystem(db_connection_string)
    ...
    def forward(self, query: str, context_type: str = "general", max_results: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            retrieval_result = self.retriever.forward(
                ...
                search_categories=query_result["search_categories"],
                limit=max_results
            )
...
def get_relevant_context(query: str, db_connection_string: str = None) -> Dict[str, Any]:
...
def search_documentation(query: str, category: str = None, db_connection_string: str = None) -> Dict[str, Any]:
...
def get_task_context(task_description: str, task_type: str = "development", db_connection_string: str = None) -> Dict[str, Any]:
    """Get relevant context for a specific task"""
