...
class CursorModelRouter(Module):
    ...
    def forward(self, query: str, context_size: int = None, 
                task_type: str = None, urgency: str = "medium", 
        ...
        dspy.Assert(selected_model in CURSOR_MODEL_CAPABILITIES, 
                   f"Invalid model selection: {selected_model}")
...
class ContextEngineeredPrompt(Module):
    ...
    def forward(self, query: str, model: CursorModel, 
                task_type: str, context_engineering: str) -> str:
        ...
        engineered_prompt = f"{patterns.get('prompt_pattern', 'I\'ll help you with this.')}\n\n"
...
class ModelRoutingValidator:
    ...
    def validate_routing_decision(self, routing_result: Dict[str, Any], 
                                 query: str, expected_model: str = None) -> Dict[str, Any]:
    ...
    def get_validation_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_confidence": sum(v["validation_result"]["confidence_score"] for v in self.validation_history) / total,
...
class ModelRoutingMonitor:
    ...
    def log_routing_attempt(self, query: str, routing_result: Dict[str, Any], 
                           latency_ms: float, validation_result: Dict[str, Any] = None):
...
class ValidatedCursorModelRouterInterface(CursorModelRouterInterface):
    ...
    def route_query(self, query: str, **kwargs) -> Dict[str, Any]:
        ...
        validation_result = self.validator.validate_routing_decision(
