...
from utils.opentelemetry_config import OpenTelemetryConfig, trace_operation, add_span_attribute
...
class ProductionMonitor:
    ...
    def _register_default_health_checks(self) -> None:
        ...
        self.register_health_check("ollama", self._check_ollama_health)
    ...
    def _check_ollama_health(self) -> HealthCheck:
            ...
            if self.system_metrics:
                ...
                if latest_metrics.cpu_percent > 90:
                    self._record_security_event(
                        ...
                        "medium",
                        "system_monitor",
                        f"CPU usage is {latest_metrics.cpu_percent}%"
                    )
...
def initialize_production_monitoring(service_name: str = "ai-dev-tasks",
                                   service_version: str = "0.3.1",
                                   environment: str = "production",
                                   otlp_endpoint: Optional[str] = None) -> ProductionMonitor:
