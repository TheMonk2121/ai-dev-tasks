...
from monitoring.production_monitor import ProductionMonitor, HealthCheck
...
class HealthEndpointManager:
    ...
    def _register_default_dependencies(self) -> None:
        ...
        self.register_dependency(
            "file_system",
            "/tmp",
            self._check_filesystem_dependency
        )
    ...
    def _check_ollama_dependency(self) -> DependencyStatus:
