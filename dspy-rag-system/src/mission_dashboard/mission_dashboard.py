...
try:
    ...
    from mission_dashboard.mission_tracker import get_mission_tracker, MissionStatus, MissionPriority
...
try:
    production_monitor = initialize_production_monitoring(
        service_name="mission-dashboard",
...
def get_missions():
    ...
    try:
        ...
        # Get missions
        missions = mission_tracker.get_all_missions(limit=limit)
...
def get_mission(mission_id):
    ...
    try:
        ...
        return jsonify({
            'mission': dashboard_state._mission_to_dict(mission),
            'timestamp': datetime.now().isoformat()
        })
...
def update_mission_progress(mission_id):
    ...
    try:
        ...
        success = mission_tracker.update_mission_progress(
            mission_id=mission_id,
            progress=progress,
            result=result
        )
...
def cancel_mission(mission_id):
    ...
    try:
        success = mission_tracker.cancel_mission(mission_id=mission_id)
...
def get_running_missions():
    ...
    try:
        running_missions = mission_tracker.get_running_missions()
...
def handle_connect():
    ...
    try:
        dashboard_state.connected_clients.add(request.sid)
...
def handle_disconnect():
    ...
    try:
        dashboard_state.connected_clients.discard(request.sid)
