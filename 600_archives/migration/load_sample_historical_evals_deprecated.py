#!/usr/bin/env python3
"""
DEPRECATED: Sample Historical Evaluation Data Migration Script

This file has been moved to 600_archives and is deprecated.
Use scripts/migration/load_historical_evals.py --limit N instead.

Loads a sample of historical evaluation JSON files into TimescaleDB for testing.

DEPRECATED: This functionality is now available in the complete migration script
using the --limit option. Use the complete version instead.
"""
                                ...
                                json.dumps(
                                    {
                                        ...
                                        "gt_answer": case.get("gt_answer", "")[:200],
                                    }
                                ),
                            ),
                        )
