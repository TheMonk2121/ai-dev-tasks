#!/usr/bin/env python3
"""
DEPRECATED: Fixed historical evaluation data migration to TimescaleDB.
...
DEPRECATED: This version has limited format support. Use the complete version instead.
"""
