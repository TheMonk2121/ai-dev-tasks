...
def load_sample_evaluations():
    ...
    try:
        ...
        stats: dict[str, Any] = {"files_processed": 0, "runs_created": 0, "events_created": 0, "case_results_created": 0, "errors": []}
        ...
        for file_path in sample_files:
            try:
                ...
                if "overall_metrics" in data and "case_results" in data:
                    ...
                    stats["runs_created"] = int(stats["runs_created"]) + 1
                    ...
                    for metric_name, metric_value in overall_metrics.items():
                        ...
                        stats["events_created"] = int(stats["events_created"]) + 1
                    ...
                    for i, case in enumerate(case_results[:10]):  # Limit to first 10 cases
                        ...
                        stats["case_results_created"] = int(stats["case_results_created"]) + 1
                ...
                if isinstance(errors_list, list):
                    errors_list.append(f"Error processing {file_path}: {e}")
