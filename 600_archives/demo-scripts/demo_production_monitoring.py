...
def demo_security_events():
    ...
    monitor = ProductionMonitor(service_name="demo-service", service_version="0.1.0", environment="demo")
...
def demo_monitoring_integration():
    ...
    monitor = initialize_production_monitoring(service_name="demo-service", service_version="0.1.0", environment="demo")
