...
def test_env_toggles_disable_specialized_agents(monkeypatch: Any) -> None:
...
def test_default_active_agent_respects_env(monkeypatch: Any) -> None:
...
def test_agent_selection_and_fallback(monkeypatch: Any) -> None:
