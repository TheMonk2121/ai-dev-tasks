# **For Development Tasks:**> Archived for historical reference. Guidance consolidated into `100_cursor-memory-context.md` and canonical 400-series
guides.
...
### **For System Integration:**-**Architecture**: `400_system-overview_advanced_features.md`
...
### **For Backlog Management**1.**Check `000_backlog.md`**for current priorities and dependencies
...
### **For File Operations**1.**Read `400_file-analysis-guide.md`**completely (MANDATORY)
...
### **For System Integration**1.**Check `400_system-overview_advanced_features.md`**for architecture
2.**Follow integration patterns**from guides
3.**Validate against system requirements**4.**Test integration**thoroughly

## 🔧 Quick Reference Tools

### **Documentation Navigation**```bash
...
### **HIGH Priority (Read First)**- `100_cursor-memory-context.md` - Memory scaffold and current state
...
### **MEDIUM Priority (Read as Needed)**- `001_create-prd.md` - PRD creation workflow
...
### **LOW Priority (Read for Specific Tasks)**- `103_yi-coder-integration.md` - Integration details

- `100_backlog-guide.md` - Backlog management

## 🔄 Context Management

### **Context Preservation**-**Memory Scaffolding**: Modular context system implemented
...
### **Context Engineering**-**DSPy Framework**: Context engineering with assertions
...
### **Context Validation**-**Constitution Compliance**: All operations follow AI Constitution rules
