...
class TestProductionMonitor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.monitor = ProductionMonitor(service_name="test-service", service_version="0.1.0", environment="test")
    ...
    def test_health_check_creation(self):
        ...
        check = HealthCheck(name="test_check", status="healthy", response_time=0.1, last_check=datetime.now())
    ...
    def test_record_security_event(self):
        ...
        self.monitor._record_security_event(
            event_type="test_event", severity="high", source="test", description="Test security event"
        )
    ...
    def test_get_security_events(self):
        ...
        self.monitor._record_security_event(
            event_type="test_event_1", severity="low", source="test", description="Test event 1"
        )

        self.monitor._record_security_event(
            event_type="test_event_2", severity="high", source="test", description="Test event 2"
        )
    ...
    def test_alert_callback_registration(self):
        ...
        self.monitor._record_security_event(
            event_type="test_event", severity="high", source="test", description="Test event"
        )
    ...
    def test_global_instance(self):
        ...
        custom_monitor = initialize_production_monitoring(
            service_name="custom-service", service_version="1.0.0", environment="production"
        )
...
class TestHealthEndpointManager(unittest.TestCase):
    ...
    def test_dependency_registration(self):
        ...
        self.health_manager.register_dependency("test_dependency", "http://test.com", test_check)
    ...
    def test_dependency_status_creation(self):
        ...
        status = DependencyStatus(
            name="test_dep", status="healthy", response_time=0.1, last_check=datetime.now(), endpoint="http://test.com"
        )
    ...
    # Removed legacy local model dependency tests
