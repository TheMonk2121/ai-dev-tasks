...
"""
    ...
    def test_validate_scores_invalid(self):
        ...
        invalid_scores = [
            {"components": {"bv": 11, "tc": 5, "rr": 5, "le": 5, "effort": 3}, "score_total": 8.7},
            {"components": {"bv": 5, "tc": 5, "rr": 5, "le": 5, "effort": 0}, "score_total": 20.0},
        ]
...
"""
    ...
    def test_regex_patterns(self):
        ...
        self.assertIsNotNone(match)
        if match is not None:  # Type guard for linter
