...
class TestSanitizePrompt:
    ...
    def test_case_insensitive_detection(self):
        ...
        patterns = ["JavaScript:alert('xss')", "EVAL('code')", "Import os", "From sys import"]
...
class TestValidateFilePath:
    ...
    def test_valid_file_path(self):
        ...
        valid_paths = ["document.txt", "file.md", "data.pdf", "info.csv"]
    ...
    def test_invalid_extensions(self):
        ...
        invalid_paths = ["script.py", "executable.exe", "binary.bin", "script.sh"]
...
class TestValidateQueryComplexity:
    ...
    def test_complex_query(self):
        ...
        complex_query = (
            "What are the differences between Python and JavaScript programming languages, and how do they compare in terms of performance, syntax, and use cases for web development, machine learning, and system administration?"
            * 10
        )
...
class TestValidateUrl:
    ...
    def test_disallowed_domains(self):
        ...
        disallowed_urls = ["http://malicious.com", "https://evil.org/api", "http://attacker.net/data"]
...
class TestValidateJsonStructure:
    ...
    def test_invalid_data_type(self):
        ...
        with pytest.raises(ValidationError, match="Data must be a dictionary"):
            validate_json_structure(data, required_fields)  # type: ignore
...
class TestValidateListLength:
    ...
    def test_invalid_type(self):
        ...
        with pytest.raises(ValidationError, match="must be a list"):
            validate_list_length("not a list", max_items=10)  # type: ignore
...
class TestValidateConfigStructure:
    ...
    def test_invalid_config_type(self):
        ...
        with pytest.raises(ValidationError, match="Configuration must be a dictionary"):
            validate_config_structure(config, required_sections)  # type: ignore
