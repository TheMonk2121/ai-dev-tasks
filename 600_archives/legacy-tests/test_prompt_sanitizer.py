...
class TestPromptSanitizer(unittest.TestCase):
    ...
    def test_validate_file_extension(self, mock_load_config):
        ...
        mock_load_config.return_value = {
            "prompt_blocklist": [],
            "prompt_whitelist": [],
            "file_validation": {"allowed_ext": ["txt", "md", "pdf", "csv"]},
        }
    ...
    def test_sanitize_and_validate_input(self, mock_load_config):
        ...
        # Test valid input
        result = sanitize_and_validate_input(prompt="Hello world", file_path="document.txt", file_size_bytes=1024)
        ...
        # Test invalid prompt
        with self.assertRaises(SecurityError):
            sanitize_and_validate_input(prompt="Hello {{world}}", file_path="document.txt", file_size_bytes=1024)

        # Test invalid file path
        result = sanitize_and_validate_input(prompt="Hello world", file_path="../secret.txt", file_size_bytes=1024)
