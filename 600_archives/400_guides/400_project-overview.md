...
> DEPRECATED: Use `400_00_getting-started-and-index.md` (canonical index), `400_03_system-overview-and-architecture.md` (architecture), `400_04_development-workflow-and-standards.md` (workflow), and `400_06_memory-and-context-systems.md` (memory/rehydration). Live workflows: `000_core/001_create-prd.md`, `002_generate-tasks.md`, `003_process-task-list.md`.
