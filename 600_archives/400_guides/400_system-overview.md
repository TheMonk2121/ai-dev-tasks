...
> DEPRECATED: Use `400_03_system-overview-and-architecture.md` as the canonical system overview. Related details live in `400_04_development-workflow-and-standards.md` (workflow), `400_06_memory-and-context-systems.md` (context/rehydration), `400_09_automation-and-pipelines.md` (CI/automation), `400_10_security-compliance-and-access.md` (security), `400_11_deployments-ops-and-observability.md` (ops/monitoring), and `400_00_getting-started-and-index.md` (index/navigation).
...
- **Backlog Status Tracking**: `scripts/backlog_status_tracking.py` - Timestamp tracking, stale item detection, and automated alerts for in-progress items
