...
> DEPRECATED: See `400_09_automation-and-pipelines.md` (pipelines/commands), `400_11_deployments-ops-and-observability.md` (metrics/monitoring), `400_01_documentation-playbook.md` (metadata conventions), and `400_04_development-workflow-and-standards.md` (workflow hooks).
