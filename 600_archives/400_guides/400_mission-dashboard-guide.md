...
> DEPRECATED: Use `400_11_deployments-ops-and-observability.md` (ops/monitoring/metrics), `400_09_automation-and-pipelines.md` (CI/pipelines), and `400_08_integrations-editor-and-models.md` (integration touchpoints). Implementation lives in `dspy-rag-system/`.
