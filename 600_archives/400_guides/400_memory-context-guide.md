...
> DEPRECATED: Use `400_06_memory-and-context-systems.md` (canonical memory/hydration), `400_00_getting-started-and-index.md` (index/reading order), and `000_core/000_backlog.md` (live priorities). Architecture context in `400_03_system-overview-and-architecture.md`.
