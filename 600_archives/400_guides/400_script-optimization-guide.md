...
> DEPRECATED: Content integrated into core guides — see `400_04_development-workflow-and-standards.md` (developer workflow/performance practices), `400_05_coding-and-prompting-standards.md` (optimization/checklists), `400_09_automation-and-pipelines.md` (CI scripting, benchmarking, parallelization), `400_11_deployments-ops-and-observability.md` (performance monitoring/metrics), and `400_00_getting-started-and-index.md` (index). Implementation lives under `scripts/`.
