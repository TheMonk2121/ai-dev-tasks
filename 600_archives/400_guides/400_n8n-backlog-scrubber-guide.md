...
> DEPRECATED: Use `400_09_automation-and-pipelines.md` (automation/pipelines), `400_11_deployments-ops-and-observability.md` (ops/monitoring), `400_01_documentation-playbook.md` (metadata conventions), and `400_04_development-workflow-and-standards.md` (workflow hooks). Implementation is under `dspy-rag-system/src/n8n_workflows/` and related scripts.
