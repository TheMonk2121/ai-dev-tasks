...
> DEPRECATED: Use `400_08_integrations-editor-and-models.md` (integration touchpoints), `400_11_deployments-ops-and-observability.md` (ops/monitoring), and `400_04_development-workflow-and-standards.md` (workflow hooks). This local-model guide is retained for archival reference; current stack prioritizes Cursor Native integrations.
