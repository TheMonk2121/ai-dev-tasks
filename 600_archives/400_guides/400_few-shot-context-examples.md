...
> DEPRECATED: Content is covered by core guides — see `400_05_coding-and-prompting-standards.md` (prompting/few‑shot patterns and testing), `400_01_documentation-playbook.md` (metadata/cross‑refs), and `400_04_development-workflow-and-standards.md` (workflow usage).
