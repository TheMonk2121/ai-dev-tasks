...
> DEPRECATED: Use `400_06_memory-and-context-systems.md` (memory/hydration fundamentals), `400_11_deployments-ops-and-observability.md` (monitoring/metrics), `400_09_automation-and-pipelines.md` (automation/testing/CI), and `400_08_integrations-editor-and-models.md` (integration touchpoints). Implementation lives in `dspy-rag-system/`.
