...
### **For AI Assistants (Cursor)**1.**Always read `100_cursor-memory-context.md` first**- provides instant context
...
### **For New Team Members**1. Read `100_cursor-memory-context.md` for current state
...
### **For AI Assistants**1. Always read `100_cursor-memory-context.md` first
