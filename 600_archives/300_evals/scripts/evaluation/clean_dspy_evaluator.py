...
class CleanDSPyEvaluator:
    ...
    def __init__(self, profile: str = "gold", progress_log: str | None = None):
        ...
        self.results_dir: Path = Path("300_evals/metrics/dspy_evaluations")
        ...
        if config_logger_available:
            try:
                ...
                print(f"🔧 Configuration captured: {self.config_data['run_id']}")
            except Exception as e:
    ...
    def _setup_profile_environment(self):
        ...
        if self.profile == "gold":
            ...
            _ = os.environ.setdefault("GOLD_CASES_PATH", "300_evals/data/gold/v1/gold_cases.jsonl")
    ...
    def run_evaluation(
        ...
        for i, case in enumerate(cases, 1):
            ...
            try:
                ...
                # Log scoring span
                if logfire_available and logfire:
                    _ = log_scoring_span(logfire, case_id, metrics["precision"], metrics["recall"], metrics["f1_score"])
        ...
        if self.config_logger and hasattr(self, "config_data"):
            results["full_config"] = self.config_data
            ...
            try:
                _ = log_eval_metrics(
                    logfire,
                    {
                        ...
                        "oracle_retrieval_hit_rate": overall_metrics["oracle_retrieval_hit_rate"],
                        "oracle_reader_hit_rate": overall_metrics["oracle_reader_hit_rate"],
                        "oracle_file_hit_rate": overall_metrics["oracle_file_hit_rate"],
                    },
                )
            except Exception as e:
