...
class BrokenLinksFixer:
    def __init__(self, dry_run: bool = True):
        ...
        self.file_mappings = {
            ...
            "C8_COMPLETION_SUMMARY.md": "C8_COMPLETION_SUMMARY.md",
            "C9_COMPLETION_SUMMARY.md": "C9_COMPLETION_SUMMARY.md",
            "C10_COMPLETION_SUMMARY.md": "C10_COMPLETION_SUMMARY.md",
            ...
            # Fix relative paths
            "../consolidated-guides/400_comprehensive-coding-best-practices.md": (
                "consolidated-guides/400_comprehensive-coding-best-practices.md"
            ),
            ...
            "legacy-project-deliverables/CURSOR_NATIVE_AI_MIGRATION_SUMMARY.md": None,
            "docs/400_prd-optimization-guide.md": None,
