...
class AnchorHeaderScanner:
    ...
    def __init__(self, project_root: str = "."):
        ...
        self.exclude_patterns = [
            ...
            "__pycache__/",
            "node_modules/",
            "artifacts/",  # Exclude only artifacts, not all archives
            "legacy/",  # Exclude legacy, not all archives
            "legacy-archives/",  # Exclude legacy archives
            "legacy-tests/",  # Exclude legacy tests
            "artifacts/",
            "traces/",
            ".pytest_cache/",
        ]
