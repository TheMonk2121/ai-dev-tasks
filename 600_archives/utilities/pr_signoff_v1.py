# DEPRECATED: PR Sign-Off System (v1)
#
# This script has been deprecated and replaced by scripts/utilities/pr_signoff_v2.py.
#
...
# Remove Optional and Union, use modern type hints
...
class PRSignOffSystem:
    ...
    def _generate_worklog_summary(self) -> None:
        ...
        if self.worklog_path and os.path.exists(self.worklog_path):
            try:
                _ = subprocess.run(
                    ["python", "scripts/worklog_summarizer.py", "--backlog-id", self.backlog_id], check=True
                )
