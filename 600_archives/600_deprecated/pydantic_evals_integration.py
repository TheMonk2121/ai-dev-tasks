#!/usr/bin/env python3
"""
DEPRECATED: Integration example for Pydantic Evals.

This demo script is deprecated in favor of the unified evaluation harness
and v1 gold dataset. Keep only for reference. Set ALLOW_DEPRECATED_SCRIPTS=1
to run it anyway.
"""
import os, sys
