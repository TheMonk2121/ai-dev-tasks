...
- *MANDATORY BEFORE ANY FILE OPERATIONS**1.**File Analysis Requirement**- ALWAYS read `400_file-analysis-guide.md` completely (463 lines)
...
3.**Documentation Coherence**- Maintain cross-reference integrity across all documentation
...
### **Article II: Context Preservation & Memory Management**1.**Memory Context Priority**- ALWAYS read `100_cursor-memory-context.md` first in any new session
...
2.**Context Hierarchy Enforcement**-**HIGH Priority**: `100_cursor-memory-context.md`, `400_system-overview.md`, `000_backlog.md`
...
3. **Context Loss Prevention**- Reinforce critical rules at the beginning of each operation
...
### **Article III: Error Prevention & Recovery**1.**Multi-Turn Process Enforcement**- Use mandatory checklist enforcement for high-risk operations
...
2.**Error Recovery Patterns**- Follow `400_error-recovery-guide.md` for all error handling
...
### **Article IV: Documentation & Knowledge Management**1.**Documentation Architecture**- Follow modular, MECE-aligned documentation patterns
...
### **Article V: System Integration & Workflow**1.**Workflow Chain Preservation**- Maintain `000_backlog.md → 001_create-prd.md → 002_generate-tasks.md → 003_process-task-list.md` chain
...
## 🔧**IMPLEMENTATION FRAMEWORK**###**Constitution Integration Points**1.**System Prompt Integration**```markdown
...
### **Constitution Enforcement**1.**Pre-Operation Checks**- Validate against constitution rules before any operation
...
## 📊**CONSTITUTION METRICS & MONITORING**###**Compliance Tracking**-**File Safety Compliance**: 100% mandatory before file operations
...
### **Performance Indicators**-**Context Loss Prevention**: Zero critical context losses
...
### **Continuous Improvement**-**Constitution Evolution**: Update based on new research findings
...
## 🚀 **CONSTITUTION DEPLOYMENT**###**Phase 1: Immediate Implementation**1.**System Integration**: Add constitution references to all critical files
...
### **Phase 2: Enhanced Enforcement**1.**Automated Compliance**: Implement automated constitution rule checking
...
### **Phase 3: Advanced Features**1.**Constitution Analytics**: Implement constitution effectiveness tracking
...
## 📚 **CONSTITUTION REFERENCES**###**Core System Files**- `100_cursor-memory-context.md` - Primary memory scaffold
...
### **Implementation Support**- `400_error-recovery-guide.md` - Error prevention and recovery
...
## ✅**CONSTITUTION VALIDATION**###**Validation Criteria**- [ ]**File Safety**: All file operations follow safety requirements
...
### **Success Metrics**-**Zero Critical Context Losses**: No loss of critical context in AI operations
