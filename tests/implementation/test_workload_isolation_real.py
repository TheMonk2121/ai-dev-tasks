...
class TestWorkloadIsolationReal:
    ...
    def test_database_connectivity_verification(self):
        ...
        connectivity_ok = orchestrator._verify_database_connectivity()  # pyright: ignore[reportPrivateUsage]
    ...
    def test_isolation_verification_real_database(self):
        ...
        verification_passed = orchestrator._verify_isolation("default")  # pyright: ignore[reportPrivateUsage]
    ...
    def test_concurrent_workload_isolation_real_database(self):
        ...
        # Collect results
        worker_results: list[tuple[int, str, bool, str | None]] = []
