...
def main():
    ...
    parser.add_argument("--sweep", action="store_true", help="Sweep thresholds from 0.80 to 0.95")
    parser.add_argument("--prompt-category", type=str, help="Prompt category for dynamic threshold selection")
    parser.add_argument("--output", type=str, default="prompt_eval_results.json", help="Output file for results")
