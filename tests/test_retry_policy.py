...
from src.utils.retry_wrapper import (
    retry, retry_http, retry_database, retry_llm,
    load_error_policy, is_fatal_error,
    RetryableError, FatalError, TimeoutError, DataStoreError,
    AuthenticationError, ResourceBusyError, ConfigurationError
)
...
class TestIsFatalError:
    ...
    def test_exact_type_match(self):
        ...
        assert is_fatal_error(error, fatal_errors) == True
    ...
    def test_fatal_exception_types(self):
        ...
        assert is_fatal_error(auth_error, []) == True
        assert is_fatal_error(data_error, []) == True
    ...
    def test_non_fatal_error(self):
        ...
        assert is_fatal_error(error, fatal_errors) == False
