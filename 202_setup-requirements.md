...
- **Setup Instructions**: See `100_cursor-memory-context.md`
...
sudo -u postgres createdb ai_agency  # cSpell:ignore createdb
sudo -u postgres psql -c "ALTER USER danieljacobs WITH PASSWORD 'your_password';"  # cSpell:ignore psql
...
### **S-007: Virtual Environment Setup**
...
- **Setup Instructions**: See `500_c8-completion-summary.md`
